...
import numpy as np
from collections import defaultdict
from ru_cococo_website.App.database import find_bigrams, bigram_trigram_rel, find_trigrams, find_fourgrams, PART_OF_SPEECH_ORDER
from ru_cococo_website.App.database import TOTAL_BIGRAM_COUNT, create_colligation_global
from ru_cococo_website.App.request import WebRequest
